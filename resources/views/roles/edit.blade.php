<div class="modal fade" id="EditRolModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="POST" id="formularioE">
                    ...
                    <div class="row">
                        <div class="col-6 py-2 input-grupo" id="grupo__nombre">
                            <label for="nombre" class="col-form-label fw-bold input-grupo">Rol</label>
