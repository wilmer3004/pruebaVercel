    ...
    <div class="container d-flex flex-row-reverse">
        <div class="col-md-6 col-sm-8 col-lg-4 px-5 py-4">
            <div class="bg-white d-flex justify-content-around align-items-center around shadow-lg p-3 mb-5 bg-body rounded">
                <div>
                    <h3 class="fs-2">{{ $totalfechast }}</h3>
                    <p class="fs-5">Trimestres Año</p>
                </div>
                <i class="fas fa-calendar-alt fs-1 primary-text border rounded-full secondary-bg p-3"></i>
            </div>
        </div>
    </div>
    {{-- End Trimestre Año card --}}

    {{-- Content --}}
    <div class="container">

        <h1 class="mb-3 text-center">TRIMESTRES DEL AÑO</h1>

        <div class="container d-flex flex-row-reverse">
            <a href="" type="button" class="btn btn-large my-3 mx-2 boton" data-bs-toggle="modal"
                data-bs-target="#CreateTrimestreAniolModal"><i class="fas fa-plus-circle me-2"></i>Agregar Trimestre</a>
        </div>

        <div class="col container">
            <table class="table" id="trimestresanio">
                <thead>
                    <tr>
{{--                         <th scope="col" width="80">#</th>
 --}}                        <th scope="col" width="">N. Trimestre</th>
                        <th scope="col" width="">Fecha Inicio</th>
                        <th scope="col" width="">Fecha Fin</th>
    ...
    @include('trimestresanio.edit')
    @include('trimestresanio.js')
@endsection
